...
const villagerCanvas = document.createElement('canvas');
villagerCanvas.width = 128;
villagerCanvas.height = 192;
...
const merchantCanvas = document.createElement('canvas');
merchantCanvas.width = 128;
merchantCanvas.height = 192;
...
const blacksmithCanvas = document.createElement('canvas');
blacksmithCanvas.width = 128;
blacksmithCanvas.height = 192;
